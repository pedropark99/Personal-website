...
description: With this package, you easily apply a function over multiple columns of a Spark DataFrame
date: '2022-12-21'
...
I work a lot with data pipelines using Apache Spark and `pyspark` at [Take Blip](https://takeblip.net). Some day, I got myself writing a very long `agg()` statement to aggregate multiple columns of my Spark DataFrame with the same function, like this one below:

...
## Elasticsearch/Opensearch native Spark drivers

If you want to write data from Spark fast and with high scalability, you want to use a Spark native driver
to write your data. Thankfully, both Elasticsearch and Opensearch have a free/open-source Spark native

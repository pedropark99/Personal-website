...
You can see in this figure that, the density grid is a grid of $50 \times 50 = 2500$ cells.
Each cell have width and height equal to $d_{sep}$.

That is why the functions `get_density_col()` and `get_density_row()` always return an integer value
as output. Because they calculate the coordinates of the cell in which the original coordinate in

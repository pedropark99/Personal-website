...
categories: ["Joins", "Teaching", "Book", "R Language"]
date: 2021-01-02
...
Porém, certa confusão pode ser facilmente aplicada em ambas alternativas. Digo, um aluno pode facilmente enfrentar a seguinte questão: "`r emoji::emoji("thinking")` Uhmm... Eu não me lembro muito bem. Um *left join* mantém as linhas da tabela `A`? Ou são as linhas da tabela `B`?"; ou então, "`r emoji::emoji("thinking")` Pera! Mas qual das duas tabelas está a direita?".

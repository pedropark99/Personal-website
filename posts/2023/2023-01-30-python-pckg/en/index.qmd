...
In 2022, I developed my first Python package called [`spark_map`](https://github.com/pedropark99/spark_map), and published it at PyPI. [I introduced this package in a previous post](https://pedro-faria.netlify.app/posts/2022/2022-12-21-spark-map-v0.2.3/en/), where I show a small use case, if you are want to know more about this package 😉.

Although `spark_map` is a small Python package, I had a hard time developing it. More specifically, the Python code was not hard to develop. But packaging it into a proper package 📦 was hard. In this post, I want to share a few things that I learned about Python package development in this process.
...
Also, a Python package usually contains these folders (or directories) too:

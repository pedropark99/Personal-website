...
This article discuss my experience on improving the Data Storytelling on a monthly report delivered to BMG Bank, which is one of the largest commercial banks in the brazilian market. I work as a Data Analyst at TakeBlip^[TakeBlip is a technology company that provide several services and infrastructure to many of the largest companies in the brazilian market, in a vast range of markets (e.g. financial services, telecomunications, health services, retail, and many others).], and one of my key responsibilities is to use data to guide my clients to improve their perfomance in our Blip platform.

# Data Storytelling is not about the "best visualization"

The majority of analysts and scientists understand what "data storytelling" is about. However, there are a few analyts that understand "data storytelling" solely as a visualization problem, or, as the science of "choosing the best graphs" for your presentation, and designing innovative, beautiful and complex charts.
...
The model of the four C's is about these four words:

...
Contudo, data storytelling é sobre **contar histórias com dados**. Não sobre construir visualizações. Escolher a visualização certa, torná-la melhor, mais bonita e mais limpa, é muito importante, porque isso vai te ajudar a contar sua história de uma maneira mais clara e eficaz, e, com isso, atingir um público maior.
...
Pois ao identificar essas ações, ele tem a capacidade de aplicar essas ações em outras partes de seu negócio, com o objetivo de disseminar esse efeito positivo que você descreveu.

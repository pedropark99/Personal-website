...
No meu entendimento, existem dois caminhos principais que podemos utilizar para atingirmos um modelo mais claro e efetivo de apresentação:

1. Evitar itens que dispersam a atenção dos nossos espectadores;
2. Construírmos uma história para a nossa apresentação;

O primeiro item acima está mais relacionado à remover itens desnecessários, e a apresentar o conteúdo da apresentação de forma mais simples e clara. Já o segundo item está mais relacionado ao conteúdo e à estrutura de nossa apresentação.
...
Isso ajuda a tornar o conteúdo mais simples. Quando você buscou aprender um assunto complexo, você provavelmente dividiu o conteúdo em várias partes e foi aprendendo uma parte de cada vez. Não foi? Traga essa experiência também para as suas apresentações.



## Discutindo histórias e conteúdo
...
Em seguida, vamos tentar aplicar as dicas discutidas até o momento para melhorar o slide mostrado em @fig-divisao2. Depois dessa pequena demonstração, vou discutir algumas estruturas básicas que podem servir como guias muito úteis para a construção de sua história.
...
# Colocando algumas dicas em prática

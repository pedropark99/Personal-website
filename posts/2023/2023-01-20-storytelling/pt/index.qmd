...
Como você pode esperar de todo grande trabalho como este, ele também envolveu outras pessoas. Durante esse processo, eu tive ajuda de meus colegas de trabalho, [Andressa de Souza Freitas](https://www.linkedin.com/in/andressa-de-souza-freitas-697195177/) e [Guilherme Gomes](https://www.linkedin.com/in/guilhermeggarcia/), mas também, tive uma grande ajuda da UX Designer [Alê Fernandes](https://www.linkedin.com/in/alefernandesbranding/). Portanto, vários dos conhecimentos apresentados aqui, eu aprendi com a Alê. Esses conhecimentos revolucionaram a maneira como eu construo minhas apresentações, e, por isso, eu sou imensamente grato a ela ❤️.
...
Na próxima seção, eu descrevo como era esses relatórios que eu apresentava para o Banco BMG. Ou seja, eu mostro como esses relatórios eram antes das melhorias, e descrevo quais eram os seus problemas e suas limitações.

Nas seções seguintes, eu dou dicas sobre como melhorei esses relatórios. Eu entendo que boa parte do sucesso em *data storytelling* (ou das melhorias que fiz em meus relatórios) está concentrada em dois pontos:
...
Por isso, a @sec-guerra-atencao fornece duas dicas que te ajudam a trazer simplicidade e clareza para sua apresentação, além de discutir o que se deve evitar para não atrair a atenção de seus espectadores para os lugares errados.

Na @sec-historia-conteudo discuto algumas dicas sobre como formar o conteúdo da apresentação, e sobre como esse conteúdo te ajuda a formar uma história.
...
Por outro lado, na @sec-historias-tem-estrutura, nós discutimos bastante sobre estrutura. Mais especificamente, eu discuto dois exemplos de estruturas que podem servir como um guia, ao fornecer uma base simples que você pode utilizar para construir a sua história.
...
Agora que você possui uma noção do tamanho que era o problema, nas próximas seções deste artigo, vou discutir algumas dicas essenciais que demonstram como nós podemos melhorar o modelo de apresentação mostrado em @fig-print-report1.

No meu entendimento, boa parte do sucesso em *data storytelling* está em duas ações:
...
Isso ajuda a tornar o conteúdo mais simples, e, como resultado, isso ajuda os seus espectadores a entenderem melhor sobre o que você está falando. Pense um pouco sobre isso. Quando você busca aprender sobre um assunto complexo, você provavelmente divide o conteúdo em várias partes pequenas, e, vai aprendendo uma parte de cada vez. Não é assim que você faz? Traga essa experiência também para as suas apresentações.
...
Na @sec-pratica, vamos tentar aplicar as dicas discutidas até o momento para melhorar o slide mostrado em @fig-divisao2. Depois dessa pequena demonstração, vou discutir na @sec-historias-tem-estrutura, algumas estruturas básicas que podem servir como guias muito úteis para a construção de sua história.
...
Lembre-se que temos dois efeitos principais discutidos em @sec-relacoes que explicam essa melhoria nas vendas. Vamos listá-los de maneira clara e curta em um novo slide:
...
Isso é uma oportunidade de ouro! Portanto, se você tiver essa oportunidade em suas mãos, proveite ela! Lembre-se que você não trabalha sozinho. Você quase sempre está trabalhando dentro de uma equipe de pessoas, e é sempre importante saber como valorizar o trabalho de seus colegas.

Contudo, essa oportunidade nem sempre vai aparecer para você. Pois talvez os desafios que você está apresentando, foram superados de outra forma, por uma outra equipe que você não conhece, ou que não possui conexão direta.

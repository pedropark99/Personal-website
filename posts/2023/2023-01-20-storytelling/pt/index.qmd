...
Na @sec-como-era-antes, eu descrevo como eram antes esses relatórios que eu apresentava para o Banco BMG, e quais eram os seus principais problemas e limitações.

A partir da @sec-como-melhorar, eu dou dicas sobre como melhorei esses relatórios. Você vai perceber que boa parte dessas melhorias estão concentradas em dois pontos:
...
A @sec-guerra-atencao fornece duas dicas que te ajudam a trazer simplicidade e clareza para sua apresentação, além de discutir o que se deve evitar para não atrair a atenção de seus espectadores para os lugares errados.

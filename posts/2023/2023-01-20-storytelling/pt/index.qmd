...
Tente ser parsimonioso nos seus slides. Isto é, tente incluir o mínimo possível de informação dentro dele, e, em geral, evite incluir textos muito longos em seus slides. Veja o slide abaixo como exemplo. O problema principal desse slide, é que ele divide muito a atenção de seu espectador.

![](./../texto-longo.png)

Imagine você apresentando esse slide. Os seus espectadores tem que prestar atenção na sua voz, no que você está comunicando verbalmente, e, ao mesmo tempo, prestar atenção no conteúdo do slide. Contudo, esse longo parágrafo no canto esquerdo do slide é problemático. Pois ele chama atenção demais! Ele desperta tanto a nossa curiosidade, que ao ver a imagem acima, você mesmo provavelmente tentou ler esse parágrafo longo antes mesmo de ler o que estou descrevendo agora. O mesmo vai acontecer com os espectadores de sua apresentação.

Ou seja, os seus espectadores vão imediatamente tentar ler esse parágrafo longo. Contudo, ler e interpretar um texto longo, exige muita atenção. Como resultado, enquanto os seus espectadores leêm esse parágrafo, eles não vão conseguir prestar atenção em outros elementos da apresentação. Por exemplo, na sua fala. Isso pode ser crucial, pois talvez você traga uma informação a mais, ou uma conexão extremamente importante na sua fala, e eles podem acabar perdendo isso.
...
Apenas para fornecer um exemplo bobo sobre isso, veja o slide abaixo.

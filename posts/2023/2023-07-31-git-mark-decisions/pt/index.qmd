...
│ 
├───📁 ClientY# Qual é o argumento deste artigo?

Para melhorar seu processo de tomada de decisão, você precisa realmente se lembrar de quais decisões você tomou em primeiro lugar.
Às vezes, essa lembrança é realmente difícil.

Pessoas diferentes usam estratégias diferentes para acompanhar as decisões que tomaram. Algumas pessoas mantêm várias anotações sobre
cada decisão, outros, gostam de documentar suas decisões dentro dos cartões criados no quadro kanban.

Independentemente da estratégia que você escolher, ela sempre envolverá algum tipo (ou nível) de rastreamento e documentação das decisões
você faz ao longo do caminho. Neste artigo, mostro um exemplo do mundo real em que o Git e o Pull Request formal desempenharam esse papel.

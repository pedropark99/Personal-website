...
para convencer o nosso cliente na época (que era um dos maiores bancos do mercado brasileiro)
...
que um usuário consiga adquirir esse empréstimo, ele precisava necessariamente ser elegível
para três modalidades diferentes.
...
No dia seguinte, eu tinha todos os dados localmente na minha máquina, e começamos a analisá-los, investigando

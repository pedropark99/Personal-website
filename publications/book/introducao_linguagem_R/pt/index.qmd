...
subtitle: "Este livro oferece uma descrição profunda sobre os fundamentos da linguagem R, e como eles se aplicam no contexto da análise de dados."
authors: ["Pedro Duarte Faria", "João Pedro Figueira Amorim Parga"]
...
cat(readr::read_file("./../buttons-pt.html"))
```
...
Você pode adquirir uma [versão física do livro através da loja da Amazon](https://amz.run/5UiQ). Uma versão eBook do livro também está disponível. Ao adquirir esses produtos, você estará me ajudando a continuar com esse projeto e a contribuir com nossa comunidade brasileira de R.
